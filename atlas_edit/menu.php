          ...
          <table>
            ...
            <tr>
              <td class="menu_button">
                ...
                <span class="right"><b>Summaries of libraries:</b>
                  <ul style="margin: 0; padding-left:20px; list-style: none;"><li>Provides information and description about the samples sequenced and analyzed at Schmidt's lab.</li></ul>
                </span></a>
              </td>
              <td class="menu_button">
